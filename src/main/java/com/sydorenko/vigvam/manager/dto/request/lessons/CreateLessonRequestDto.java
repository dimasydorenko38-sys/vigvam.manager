...
public class CreateLessonRequestDto {
    ...
    public CreateLessonRequestDto(@NonNull PlanningLessonResponseDto planLesson, @NonNull LocalDate date) {
    ...
    public CreateLessonRequestDto(@NonNull PlanningLessonResponseDto planLesson, @NonNull LocalDate date, String comments) {
        this.lessonStatus = planLesson.getLessonStatus().name();
        this.childId = planLesson.getChildId();
        this.serviceTypeId = planLesson.getServiceTypeId();
        this.lessonType = planLesson.getLessonType().name();
